  ...
  return (
    <>
      <div className="relative min-h-screen md:flex" data-dev-hint="container">
        ...
        <header
          className="bg-blue-400 text-gray-100 flex justify-between md:hidden"
        ...
        <aside
          id="sidebar"
          className="bg-blue-500 text-gray-900 md:w-64 w-3/4 space-y-6 pt-6 px-0 absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out  md:flex md:flex-col md:justify-between overflow-y-auto"
        ...
        >
          ...
          >
            ...
            <nav data-dev-hint="main navigation">
              ...
              >
                <span className="ml-6">Add Service</span>
              </Link>
              <Link
                to="/Dash/Updateservice"
                className="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white"
              >
                <span className="ml-6">Update Service</span>
              </Link>
              <Link
                to="/Dash/Database"
                className="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white"
              >
                <span className="ml-6">Database</span>
              </Link>

              <Link
                to="/"
                className="flex items-center space-x-2 py-2 px-4 mt-96 transition duration-200 hover:bg-gray-700 hover:text-white"
              >
